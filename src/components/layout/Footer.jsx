...
import icon_pay_01 from '../../assets/images/icons/icon-pay-01.png'
import icon_pay_02 from '../../assets/images/icons/icon-pay-02.png'
import icon_pay_03 from '../../assets/images/icons/icon-pay-03.png'
import icon_pay_04 from '../../assets/images/icons/icon-pay-04.png'
import icon_pay_05 from '../../assets/images/icons/icon-pay-05.png'

function Footer() {
    return (
        <footer className="bg3 pt-75 p-b-32">
